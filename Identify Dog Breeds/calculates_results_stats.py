...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_notdogs_img'] = sum([1 for key in results_dic if results_dic[key][3] == 0])

    # Number of Correct Dog matches
    results_stats_dic['n_correct_dogs'] = sum([1 for key in results_dic if results_dic[key][3] == 1 and results_dic[key][4] == 1])

    # Number of Correct "Not-a" Dog matches
    results_stats_dic['n_correct_notdogs'] = sum([1 for key in results_dic if results_dic[key][3] == 0 and results_dic[key][4] == 0])

    # Number of Correct Breed matches
    results_stats_dic['n_correct_breed'] = sum([1 for key in results_dic if results_dic[key][3] == 1 and results_dic[key][2] == 1])

    # Percentage of Correct Match
    results_stats_dic['pct_match'] = (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs']) / results_stats_dic['n_images'] * 100.0
